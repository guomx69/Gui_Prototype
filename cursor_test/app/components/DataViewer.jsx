...
import "@esri/calcite-components/dist/components/calcite-table-header-cell";
  ...
  return (
    <CalcitePanel heading="Data Viewer">
      ...
      <CalciteTable>
        <CalciteTableHeader>
          <CalciteTableRow>
            <CalciteTableHeaderCell onClick={() => handleSort('id')}>
              ID {sortColumn === 'id' && (sortDirection === 'asc' ? '▲' : '▼')}
            </CalciteTableHeaderCell>
            <CalciteTableHeaderCell onClick={() => handleSort('name')}>
              Name {sortColumn === 'name' && (sortDirection === 'asc' ? '▲' : '▼')}
            </CalciteTableHeaderCell>
            <CalciteTableHeaderCell onClick={() => handleSort('age')}>
              Age {sortColumn === 'age' && (sortDirection === 'asc' ? '▲' : '▼')}
            </CalciteTableHeaderCell>
            <CalciteTableHeaderCell onClick={() => handleSort('city')}>
